  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-white bg-tosca fixed-top">
        ...
        <div class="">
            ...
            <a class="text-white breeserif font-weight-bold navbar-brand ml-2" href="#">Pengaduan Masyarakat</a>
        ...
        <div class="">
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <li class="nav-item">
            <a class="nav-link breeserif font-weight-bold text-white" href="/login">Login</a>
                </li>
                <li class="nav-item active">
                <a class="nav-link breeserif font-weight-bold text-white" href="/register">Register</a>
                </li> 
            </div>
        </div>
        </div>
    ...
    <div class="container mt-5 py-5">
        <div class="row">
          <div class="col-md-6">
            ...
            <p> <br>
                <button type="" class="btn btn-tosca text-white breeserif creteround font-weight-bold"> Buat Laporan Pengaduan </button>
                </p>
            </div>
              <div class="col-md-6">
        ...
        <div class="row">
            <div class="col-md-6">
              <h2 class= "patua font-weight-bold text-dark"> Tujuan Pengaduan Masyarakat </h2>
                ...
                a. Untuk Menindak lanjuti pengaduan masyarakat secara cepat dan tepat
                 </h5>
                <h5 class="acme font-weight-bold text-dark"> 
                c. mengeliminasi penyimpangan-penyimpangan yang timbul
                </h5>
                <h5 class="acme font-weight-bold text-dark">
                d. Memberdayakan masyarakat untuk berperan aktif dalam membantu 
                <h5>  
            </div>
            <div class="col-md-6">
